...
pub struct Refund<'info> {
    ...
    #[account(
        ...
        bump = escrow.bump,
        constraint = ( maker.key() == escrow.maker.key() )       // TBD: Understand if this is needed and why is needed -> See documentation constraints on account
    )]                                                           // "require!(maker.key() == escrow.maker.key)" same thing inside the code
